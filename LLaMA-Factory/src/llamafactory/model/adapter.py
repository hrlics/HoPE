...
def _setup_freeze_tuning(
    ...
    # modify
    if not finetuning_args.freeze_multi_modal_projector: # train projector 
        if model_type == "qwen2_vl":
            trainable_layers.append("visual.merger")
        else:
            raise ValueError("Other multi-modal models are not supported yet.")
